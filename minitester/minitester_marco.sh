...
{
	print_h3 "RANDOM TESTS"
	exec_test	"cd ../../../../../.."
	exec_test	"cd ~"
	exec_test	"cd"
	exec_test	"cd ~/Desktop"
	exec_test	"unset HOME - cd ~"
	exec_test	"export HOME=/Users/user42 - cd ~"
	exec_test	"cd .. cool swag"
	exec_test	"cd Eyooooo"
	exec_test	"cd -"
	exec_test	"cd -"
	exec_test	"mkdir a - mkdir a/b - cd a/b - rm -r ../../a - cd .."
	exec_test	"echo"
	exec_test	"echo $NonExistingVar"
	exec_test	"echo $PATH"
	exec_test	"echo ~"
	exec_test	"echo -n -n -nnnn -nnnnm"
	exec_test	"echo -n -nnn hello -n"
	exec_test	"env"
	exec_test	"env Weeiirrddd"
	exec_test	"cd Weyooo - echo $?"
	exec_test	"random_cmd - echo $?"
	exec_test	"./file_that_is_not_an_executable"
	exec_test	"cat bla"
	exec_test	"hi"
	exec_test	'export ls="ls -l" - $ls'
	exec_test	"echo $ls"
	exec_test	"export var=a - export $var=test - echo $var $a"
	exec_test	"export $var=test - unset var"
	exec_test	"export test1 - env"
	exec_test	"export test2= - env"
	exec_test	"export var - export var=hoi - export"
	exec_test	"export "" test=a"
	exec_test	"export test3=$HOME"
	exec_test	"echo ~"
	exec_test	"$SHLVL"
	exec_test	""""
...
#	exec_test	"cat | cat | cat | ls"
	...
	exec_test	"exit > hoi.txt"
	exec_test	"env | grep OLDPWD"
	exec_test	"cd .. > derp.txt"
	exec_test	"> file"
	...
	exec_test	"Non_exist_cmd > salut"
	exec_test	"unset all envs - env"
	exec_test	"unset all envs - export lol"
	exec_test	"Infinite file"
	...
	exec_test	""
	exec_test	""
	exec_test	"export $var ($var does not exists)"
	...
	exec_test	"export test="file1 file2" ; >"$test""
	exec_test	"export test="file1 file2" ; >$test >hey"
	exec_test	"export test="file1 file2" ; >hey >$test"
	exec_test	"|"
	exec_test	"echo bonjour ; |"
	exec_test	"echo bonjour > > out"
	exec_test	"echo bonjour > $test"
	exec_test	"echo bonjour > $test w/ test="o1 o2""
	exec_test	"echo bonjour >>> test"
	exec_test	"echo bonjour | |"
	exec_test	"echo bonjour |;"
	exec_test	"unset PATH ; echo $PATH"
	...
	exec_test	"cat wfeh | cat csijdsji | cat nfwir"
}
